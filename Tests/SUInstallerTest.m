...
- (void)testInstallIfRoot
{
    ...
    id<SUInstallerProtocol> installer = [SUInstaller installerForHost:host updateDirectory:[path stringByDeletingLastPathComponent] inheritsPrivileges:YES versionComparator:[SUStandardVersionComparator standardVersionComparator] error:&installerError];
