...
{
    return [NSString stringWithFormat:@"%@ <%@>", [self class], [host bundlePath]];
}
...
- (void)displayReleaseNotes
{
    ...
    if ([familyName hasPrefix:@"."])
    { // 10.9 returns ".Lucida Grande UI", which isn't a valid name for the WebView
