...
- (instancetype)initWithCoder:(NSCoder *)decoder
{
    ...
    if (self != nil) {
        ...
        _hardwareRequirements = [(NSSet<NSString *> *)[decoder decodeObjectOfClasses:[NSSet setWithArray:@[[NSString class], [NSSet class]]] forKey:SUAppcastElementHardwareRequirementsKey] copy];
