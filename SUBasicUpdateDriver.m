...
- (void)installWithToolAndRelaunch:(BOOL)relaunch
{
    ...
    BOOL useXPC = running10_7 && [[NSFileManager defaultManager] fileExistsAtPath:[[host bundlePath] stringByAppendingPathComponent:@"Contents/XPCServices/com.andymatuschak.Sparkle.SandboxService.xpc"]];
