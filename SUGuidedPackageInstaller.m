...
NSString* SUInstallerGuidedInstallerFilename = @".sparkle_guide.plist";
...
+ (void)performInstallationWithInfo:(NSDictionary *)theInfo
{
	...
	if (error == nil)
	{
		...
		NSString* packagePath = [[theInfo objectForKey:SUGuidedPackageInstallerKeyGuide] objectForKey:SUGuidedPackageInstallerGuideKeyPackage];
...
//				[installerPath fileSystemRepresentation],
	...
	NSMutableDictionary* resultInfo = [[theInfo mutableCopy] autorelease];
